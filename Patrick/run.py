...
import os
# cd ~/code/steps_cell_signaling/; PYTHONPATH=$PWD python3 Patrick/run.py


ellipsoidity = 1.0      # ellipsoidity: 0=sphere, 1=ellipsoid
n_reps = 1             # number of repetions
runnr = 10
all_results = []
...
try:
    ...
    save_dir = f"{base_path}Patrick/saved_objects/run{runnr}"
